...
This project is an Open Source / Open Hardware minimalis approach for a Web Relay Board. +
...
* link:https://github.com/tducret/programmateur-fil-pilote-wifi/tree/master/Mat%C3%A9riel/1.3/Tutoriel[]
* link:http://www.wiki.coworking-aurillac.fr/esp-8266-commande-radiateurs-electriques-sur-fil-pilote/[]